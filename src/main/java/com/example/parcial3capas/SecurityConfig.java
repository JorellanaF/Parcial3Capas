...
public class SecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/admin","/registro", "/validarR","/listadoU","/editUsuario","/listadoC","/editCentroE","/agregarC","/validarC","/listaM","/editM","/agregarM","/validarM").hasAuthority("Administrador")
                .antMatchers("/registroE","/validarEs","/editarEs","/listadoE","/buscarE","/listadoME","/validarME","/editME","/validarEditME").hasAuthority("Coordinador")
